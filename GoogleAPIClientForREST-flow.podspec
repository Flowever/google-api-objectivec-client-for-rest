Pod::Spec.new do |s|
  ...
  s.source       = { :git => 'https://github.com/Flowever/google-api-objectivec-client-for-rest.git',
                     :tag => "v#{s.version}" }
  ...
  # project's headers.
  s.dependency 'GTMSessionFetcher-flow', '>= 1.1.13'
  ...
  s.subspec 'Drive' do |sp|
    sp.dependency 'GoogleAPIClientForREST-flow/Core'
